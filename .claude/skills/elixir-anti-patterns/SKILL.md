...
Call `mcp__elixir-mcp__get_module_docs` (from the `elixir-mcp` MCP server) with `"code-anti-patterns"`, `"design-anti-patterns"`, `"process-anti-patterns"`, or `"macro-anti-patterns"`.
